# Загрузка данных
data <- read.csv("C:/Users/Наргиза/Documents/household_power_consumption.txt", sep=";", header=TRUE, stringsAsFactors=FALSE, na.strings="?")
...
# Линейный график с тремя субметрингами энергии
